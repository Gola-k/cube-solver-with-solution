...
print(
    rf"{GREEN}         | |       |  |   |  |  |  _____  |  |  ____|                                    |   |   |   |            ")
print(
    rf"{GREEN}         | |____   |  |___|  |  | |_____| |  | |_______                                  |_I_|_E_|_E_|_E           ")
print(
...
def color_detect(h, s, v):
    # print(h,s,v)
    if 0 < h < 8 and 172 < s < 255 and 101 < v < 255:
        return 'red'
    elif 7 < h < 20 and v > 120:
        return 'orange'
    elif 22 < h < 60 and s > 60:
        return 'yellow'
    elif 51 < h < 80 and s > 50:
        return 'green'
    elif 90 < h <= 110 and s > 120:
        return 'blue'
    elif 0 < h < 180 and 0 < s < 34 and 192 < v < 236:
        return 'white'
